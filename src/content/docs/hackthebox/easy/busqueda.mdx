...
![Searcher.htb landing page, a minimal search front end](../../../../assets/hackthebox/easy/busqueda/busqueda-1.png)
...
![BurpSuite request to /search showing the engine and query parameters](../../../../assets/hackthebox/easy/busqueda/busqueda-2.png)
*This confirms the application is directly processing user-controlled input before performing the search logic.*

![Looking again at the landing page footer, the backend engine is revealed as Searchor 2.4.0.](../../../../assets/hackthebox/easy/busqueda/busqueda-3.png)
...
![Reverse shell landing as the svc user](../../../../assets/hackthebox/easy/busqueda/busqueda-4.png)
...
![The Searcher_site repository inside Gitea](../../../../assets/hackthebox/easy/busqueda/busqueda-6.png)
...
![Logging into Gitea as administrator with the recovered database password](../../../../assets/hackthebox/easy/busqueda/busqueda-7.png)
...
<Principle text="Parameterize, do not sanitize." />