...
<AttackPath
  ...
  nodes={[
    { kind: 'User', name: 'svc-alfresco', detail: [ { k: 'crack', v: 'AS-REP roast → <code>hashcat -m 18200</code>' }, { k: 'shell', v: '<code>evil-winrm</code>, user.txt' } ] },
    ...
    { kind: 'Root', name: 'SYSTEM', edge: '<b>pass-the-hash</b>', detail: [ { k: 'shell', v: '<code>evil-winrm</code> PtH as Administrator' }, { k: 'flag', v: 'root.txt' } ] },
  ]}
/>
